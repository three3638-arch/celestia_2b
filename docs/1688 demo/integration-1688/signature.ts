 ...
 * 规范：docs/1688-SIGNATURE-AND-CALL.md 第 3 节
 *
 * 算法：concatString = urlPath + 排序后的(key+value) 拼接；Signature = uppercase(hex(hmac_sha1(concatString, secret)))
 */
...
/**
 * 计算 1688 API 请求签名
 * @param urlPath - URL 中从路径到 "?" 前的部分，如 param2/1/system/currentTime/1688
